...
const navLinks = [
  ...
  { label: 'Paleteros y mochilas', href: '/paleteros-y-mochilas' },
...
useEffect(() => {
  ...
  <header className="sticky top-0 z-50 bg-white">
    ...
    <div className="padel-container flex h-[92px] items-center">
      ...
      <nav className="mx-auto hidden items-center gap-6 text-[13px] font-medium text-neutral-800 xl:gap-8 xl:text-[14px] lg:flex">
        {navLinks.map((link) => (
          <button
            key={link.href}
