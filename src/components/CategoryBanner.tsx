...
export default function CategoryBanner({ onViewDetail }: CategoryBannerProps) {
  ...
  className="group w-[240px] cursor-pointer text-center"
>
        <div className="flex h-[250px] items-center justify-center bg-white">
          <img
            src={product.image}
            alt={product.name}
        ...
        <p className="mt-1 min-h-[42px] text-[13px] font-bold leading-snug text-neutral-950 group-hover:text-[#f04b2f]">
  {product.name}
</p>

        <p className="mt-2 text-[15px] font-black text-neutral-950">
